...
该部分聚焦于盘古 - 1B 模型的推理延迟优化，核心技术手段涵盖 chunk prefill、NPU 图编译（NPU graph）及量化等。我们系统探究了各类优化技术的独立效能与作用机制，并通过多策略协同融合，将模型端到端推理性能提升2.726倍。
...
| -------- | ------ | ------ | ------ | ------ |
| 2.006s   | 2.224s | 2.059s | 2.004s | 2.105s |
...
| --------- | ----- | ----- | ----- | ----- | ----- |
| w/o optim | 3.988 | 3.731 | 3.682 | 3.905 | 4.073 |
| w optim   | 1.463 | 1.549 | 1.597 | 1.600 | 1.663 |
| 加速      | 2.726 | 2.408 | 2.305 | 2.440 | 2.449 |
